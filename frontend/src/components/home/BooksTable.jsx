      ...
      <table className="w-full border-separate border-spacing-2">
        <thead>
          <tr>
            ...
            <th className="border border-slate-600 rounded-md hidden md:table-cell">Pages</th>
        ...
        <tbody>
          {books.map((book, index) => (
            <tr key={book._id} className="h-8">
              ...
              <td className="border border-slate-700 rounded-md text-center hidden md:table-cell">{book.pages}</td>
